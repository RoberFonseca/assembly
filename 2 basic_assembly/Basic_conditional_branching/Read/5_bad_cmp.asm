...
; Because is considering the sign flag and not the carry, the results on left mostbyte will be taken as negative numbers everytime. (That's the main diff with the last ex).
