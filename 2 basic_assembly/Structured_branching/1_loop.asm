...
; Pide un n, loopea n veces y va multiplicando n*n, el resultado lo anade a esi, por lo que esi va a ser la sumatoria de cada iteración multiplicada por si misma. Por ultimo muestra esa sumatoria.
