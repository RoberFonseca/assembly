...
; This program multiply a value with itself, store it and multiply by itself, then do the same with another number and substract the second value from the first
